...
export default function ClearanceApprovalModal({
    params,
    onNoteCreated,
}: UserName) {
    ...
    useEffect(() => {
        async function fetchData() {
            const fetchedCleranaces = await getClearances();
            setProjects(fetchedCleranaces);
        }
        fetchData();
            ...
            <Card className="w-full max-w-xl bg-background">
                <CardHeader>
                    <CardTitle className="flex flex-row justify-between ">
                        <div className="pt-4">Clearance Form</div>
                    ...
                    <CardDescription>
                        Fill in the details for the new clearance.
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <Form {...form}>
                                    ...
                                    <FormItem>
                                        ...
                                        >
                                            <SelectTrigger id="project">
                                                <SelectValue placeholder="Select a clearance" />
                                            </SelectTrigger>
                                            <SelectContent>
                                                {projects.map(
                                                    (project: any) => (
