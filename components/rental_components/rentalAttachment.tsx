...
interface UploadProps {
    params: { rental: string; uploader: string, fileSuffix: string };
}

export default function RentalAttatchment({ params }: UploadProps) {
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            formData.append("parentId", params.rental);
            formData.append("uploader", params.uploader);
            formData.append("AttachmentType", 'Rental');
